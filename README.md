...
# **UseCase-диаграмма**
![Диаграмма use-case](use-case.drawio.png)

# **Контекстная диаграмма в нотации IDEF0**
![Диаграмма в нотации IDEF0](IDEF0_contextual.drawio.png)

# **Диаграмма декомпозиции**
![Диаграмма декомпозиции](IDEF0_decomposition.drawio.png)

# **Диаграмма последовательности (Обработка нештатной ситуации)**
![Диаграмма последовательности](Диаграмма_последовательности_(Обработка_нештатной_ситуации).png)

# **Диаграмма последовательности (Списание топлива на пуск)**
![Диаграмма последовательности](Диаграмма_последовательности_(Списание_топлива_на_пуск).png)

# **Диаграмма потоков данных DFD**
![Диаграмма DFD](DFD.png)
